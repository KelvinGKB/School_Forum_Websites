...
{
    public partial class User_Comment_Post : System.Web.UI.Page
    {
        string cs = Global.CS;
                                ...
                                "<div class='dropdown' style='display:inline-block;float:right'>" +
                                   " <button class='btn btn-link dropdown-toggle' type='button' id='gedf-drop1' data-toggle='dropdown' aria-haspopup='true' aria-expanded='false' > " +
                                    ...
                                    "<div class='dropdown-menu dropdown-menu-right' aria-labelledby='gedf-drop1'>" +
                                       ...
                                       " <hr />" +
                                       " <a class='dropdown-item btn' href='add_bookmark.aspx?PID={7}' rel='modal:open'><span class='glyphicon glyphicon-flag'></span> Bookmark</a>" +
                                       " <a class='dropdown-item btn' href='#'><span class='glyphicon glyphicon-remove'></span> Hide</a>" +
                                        "<a class='dropdown-item btn' href='report_post.aspx?PID={7}' rel='modal:open'><span class='glyphicon glyphicon-bullhorn'></span> Report</a>" +
                                   "  </div>" +
                                   " </div>" +
                                 "</div>" +
"  <div  style='text-align:left;padding-left:20px;background-color:white;border-bottom:solid #C0C0C0 '>" +
                       ...
                       " <div class='card-footer' style='text-align:left;background-color:#f8f8f8;padding-left:60px;padding-top:10px;padding-bottom:50px;padding-right:20px;'>" +
                        "<a type='button' href='like.aspx?PID={7}'class='btn btn-primary col-sm-5' style='text-align:center;margin-right:100px' ><span class='glyphicon glyphicon-thumbs-up'></span>{10}</a>" +
                  "</div>" +
                ...
                while (dr2.Read())
                {
                    ...
                    if (com1 != null)
                    {
                      ...
                      " <p style='float:right;padding-right:5px'>#{5}</p>" +
                       "<a class='btn' style='float:right' href='delete_comment.aspx?CID={8}' rel='modal:open'><span class='glyphicon glyphicon-remove-sign'></span></a>" +
                          "<div style='display:inline-block;position:relative;top:-15px'>" +
                                  " <img width='50' height='50' style='border-radius:50%' src='{6}' alt=''>" +
                          " </div>" +
                          " <div class='ml-2'  style='display:inline-block;'>" +
                                  " <div class='h5 m-0'>" +
                                       "<a href='Other_Profile.aspx?UID={7}'>@{0}</a>" +
                                  " </div>" +
               ...
               "</div></td></tr>", dr2["username"], dr2["content"], dr2["date"], dr2["name"], dr2["UserID"], countD, dr2["image"], dr2["UserID"], dr2["comentId"]);
                    ...
                    else
                    {
                        ...
                        c += string.Format("<tr><td><div  style='margin-top:40px;margin-bottom:30px;margin-left:40px;border:solid #C0C0C0 ;border-radius:5px; background-color:#f8f8f8;'>" +
                           ...
                           " <p style='float:right;padding-right:5px'>#{5}</p>" +
                               "<div style='display:inline-block;position:relative;top:-15px'>" +
                                       " <img width='50' style='border-radius:50%' src='{6}' alt=''>" +
                               " </div>" +
                               " <div class='ml-2'  style='display:inline-block;'>" +
                                       " <div class='h5 m-0'>" +
                                            "<a href='Other_Profile.aspx?UID={7}'>@{0}</a>" +
    ...
    "  <div  style='text-align:left;padding-left:20px;background-color:white;border-bottom:solid #C0C0C0 '>" +
        ...
        protected void btnComment_Click(object sender, EventArgs e)
        {
            if(Page.IsValid)
            {
                ...
                string link = "User-Comment-Post.aspx?PID=" + pid;
