...
namespace Assignment_Web_Application_.User
{
    ...
    "  <div  style='text-align:left;padding-left:20px;background-color:white;border-bottom:solid #C0C0C0 '>" +
                           ...
                           " <div class='card-footer' style='text-align:left;background-color:#f8f8f8;padding-left:60px;padding-top:10px;padding-bottom:50px;padding-right:20px;'>" +
                            "<a href='category.aspx?PID={7}&cat={11}' class='btn btn-primary col-sm-5' style='text-align:center;margin-right:100px'><span class='glyphicon glyphicon-thumbs-up'></span>{10}</a>" +
        ...
        void Like_Method(string pid,string id)
        {
            ...
            if (l != null)
            {
                ...
                db.SubmitChanges();
                Response.Redirect("category.aspx?cat=" + id);
        ...
        protected void btnFilter_Click(object sender, EventArgs e)
        {
            ...
            string link = "subcategory.aspx?subID=" + sub;
