<%@ Page Title="" Language="C#" MasterPageFile="~/User/User_Panel.Master" AutoEventWireup="true" CodeBehind="Setting.aspx.cs" Inherits="Assignment_Web_Application_.User.Setting" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table style="margin-left:50px;margin-right:50px;margin-top:30px">
        ...
        <tr>
            ...
            <td class="auto-style2">
              <h3><asp:HyperLink ID="editPic" runat="server" NavigateUrl="~/User/changePic.aspx"><span class="glyphicon glyphicon-picture"></span> Change Profile Picture</asp:HyperLink></h3></td>
        </tr>
         ...
         <tr runat="server" id="trPassword">
            ...
            <td class="auto-style2">
              <h3>  <asp:HyperLink ID="editPass" runat="server" NavigateUrl="~/User/EditPass.aspx"><span class="glyphicon glyphicon-lock"></span> Change Pasword</asp:HyperLink> </h3></td>
        </tr>
