<%@ Page Title="" Language="C#" MasterPageFile="~/User/User.Master" AutoEventWireup="true" CodeBehind="NewPost_Recaptcha.aspx.cs" Inherits="Assignment_Web_Application_.User.NewPost_Recaptcha" %>
                            ...
                            var onloadCallback = function () {
                                grecaptcha.render('dvCaptcha', {
                                    ...
                                    'callback': function (response) {
                                        $.ajax({
                                            type: "POST",
                                            url: "NewPost_Recaptcha.aspx/VerifyCaptcha",
