<%@ Page Title="" Language="C#"  MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Admin_Other_Profile.aspx.cs" Inherits="Assignment_Web_Application_.Admin.Admin_Other_Profile" %>
        ...
        <div class="media">
                  <table style="font-size:large">
                      <br />
                       ...
                       <br />
                      <tr><td><asp:Literal ID="litName2" runat="server"></asp:Literal></td></tr>
                      <tr><td><asp:Literal ID="litGender" runat="server"></asp:Literal></td></tr>
                      <tr><td><asp:Literal ID="litDescription" runat="server"></asp:Literal></td></tr>
