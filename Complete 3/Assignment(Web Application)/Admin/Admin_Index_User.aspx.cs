...
{
    public partial class Admin_Index_User : System.Web.UI.Page
    {
        string cs = Global.CS;
                                    ...
                                    "<div class='dropdown' style='display:inline-block;float:right'>" +
                                       " <button class='btn btn-link dropdown-toggle' type='button' id='gedf-drop1' data-toggle='dropdown' aria-haspopup='true' aria-expanded='false' > " +
                                        ...
                                        "<div class='dropdown-menu dropdown-menu-right' aria-labelledby='gedf-drop1'>" +
                                           ...
                                           " <hr />" +
                                           " <a type='button' class='Idinfo dropdown-item btn' href='Admin_add_bookmark.aspx?PID={7}' rel='modal:open'><span class='glyphicon glyphicon-flag'></span> Bookmark</a>" +
                                           " <a class='dropdown-item btn' href='#'><span class='glyphicon glyphicon-remove'></span> Hide</a>" +
                                            "<a type='button' class='Idinfo dropdown-item btn' href='Admin_report_post.aspx?PID={7}' rel='modal:open' ><span class='glyphicon glyphicon-bullhorn'></span> Report</a>" +
                                       "  </div>" +
                                       " </div>" +
                                     "</div>" +
    "  <div  style='text-align:left;padding-left:20px;background-color:white;border-bottom:solid #C0C0C0 '>" +
                           " <a class='card-link btn' style='margin-left:-13px' href='Admin_User-Comment-Post.aspx?PID={7}'>" +
                           ...
                           " <div class='card-footer' style='text-align:left;background-color:#f8f8f8;padding-left:60px;padding-top:10px;padding-bottom:50px;padding-right:20px;'>" +
                            "<a href='Admin_Index_User.aspx?PID={7}' class='btn btn-primary col-sm-5' style='text-align:center;margin-right:100px'><span class='glyphicon glyphicon-thumbs-up'></span>{10}</a>" +
